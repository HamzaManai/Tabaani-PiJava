 ...
 */
public class MenuProprietaireController implements Initializable {
    ...
    private void add(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("AjouterProprietaire.fxml"));
    ...
    private void list(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("ListProprietaire.fxml"));
        stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
