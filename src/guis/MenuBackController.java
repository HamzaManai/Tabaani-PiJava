...
public class MenuBackController implements Initializable {
    ...
    @FXML
    private void TypeHebergementsMenu(ActionEvent event) throws IOException {
        /*
        FXMLLoader loader = new FXMLLoader(getClass().getResource("MenuTypeHebergement.fxml"));
        Parent root = loader.load();
        MenuTypeHebergementController ac = loader.getController();
         */
    ...
    @FXML
    private void PropreitairesMenu(ActionEvent event) throws IOException {
        /*
        FXMLLoader loader = new FXMLLoader(getClass().getResource("MenuProprietaire.fxml"));
        Parent root = loader.load();
        MenuTypeHebergementController ac = loader.getController();
         */
    ...
    @FXML
    private void HebergementsMenu(ActionEvent event) throws IOException {
        /*
        FXMLLoader loader = new FXMLLoader(getClass().getResource("MenuHebergement.fxml"));
        Parent root = loader.load();
        MenuTypeHebergementController ac = loader.getController();
         */
